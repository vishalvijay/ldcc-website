...
const values = [
  { icon: Users, title: "Inclusive Community", description: "We welcome diverse individuals from all backgrounds, united by our passion for cricket." },
  { icon: Trophy, title: "Competitive Excellence", description: "Striving for success while maintaining sportsmanship and respect for the game." },
  { icon: Heart, title: "Friendly Atmosphere", description: "Creating a sociable environment where friendships flourish on and off the field." },
  { icon: Target, title: "Skill Development", description: "Supporting players of all levels to improve their cricketing abilities." },
];
              ...
              <Card className="border-2">
                <CardContent className="p-8">
                  ...
                  <a
                    ...
                    className="text-primary hover:underline font-semibold"
                  >
                    View Play-Cricket Profile &rarr;
                  </a>
                </CardContent>
              </Card>
            </div>
